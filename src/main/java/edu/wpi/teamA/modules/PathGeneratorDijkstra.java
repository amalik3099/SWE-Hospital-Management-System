...
@Slf4j
public class PathGeneratorDijkstra<T extends Node> extends BestPathAlgo<T>
    implements PathGenerator<T> {

  public PathGeneratorDijkstra(
    ...
    getGraph()
        ...
        .forEach(
            connection -> {
              ...
              if (illegal.contains(nextNode.getCurrent())) newCost = Double.POSITIVE_INFINITY;
              ...
              if (neighborNode.getPathCost() > newCost) {
                ...
                neighborNode.setHeuristicCost(0);
