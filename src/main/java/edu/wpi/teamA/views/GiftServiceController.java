...
public class GiftServiceController implements Initializable, InnerServiceController {

  @FXML public AnchorPane giftPane;
  ...
  @FXML private JFXComboBox giftBox;
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    ObservableList<String> giftChoices =
        FXCollections.observableArrayList(
            "Toy Truck", "Action Figure", "Barbie", "Thoughtful Card", "Combination");
    giftBox.setItems(giftChoices);
  }
  ...
  //      r.addProperty("type", "Gift Service Request");
  //      r.addProperty("assigned", "");
  //      r.addProperty("complete", "false");
  //      r.addProperty("location", recLoc.getValue());
  //      r.addProperty(
  //          "description",
  //          "Sender: "
  //              + yourName.getText()
  ...
  //              + recipient.getText()
  //              + "; anon? "
  //              + String.valueOf(yesCheck.isSelected()));
  //
  //      db.addRecord("REQUESTS", r);
  //
  //      em.sendEmail(
  //          email.getText(), "Gift Request Submitted", "Your request was submitted
  // successfully!");
  //      clear();
  //    }
  //  }
  ...
  private boolean isGiftSelected() {
    return !(giftBox.getValue() != null && giftBox.getValue().equals(""));
  }
  ...
  private Boolean handleDialog() throws MessagingException {
    ...
    if (isRecipientCompleted()) {
      if (isGiftSelected()) {
        ...
        incContent.setBody(
            new Text("The service request is incomplete. Please complete a gift type"));
  ...
  public boolean addRequestToDB(String name, String email, boolean urgency)
    ...
    if (handleDialog()) {
      ...
      em.sendEmail(email, "Gift Request Submitted", "Your request was submitted successfully!");
      clear();
      return true;
    }
    return false;
